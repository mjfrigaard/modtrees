#' Check if an expression contains a Shiny module identifier
#'
#' Recursively walks a parsed R expression to detect calls to [shiny::NS()]
#' or [shiny::moduleServer()], which are reliable indicators that a function
#' is a Shiny module.
#'
